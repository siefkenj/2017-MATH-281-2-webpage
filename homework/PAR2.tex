...
\begin{document}
	...
	\setheader{Math 281-2}{PAR 2}{Due: 2/16 (draft), 2/17 (final)}{}{Name:\underline{\hspace{2in}}}{}
	...
	\par\begin{tikzpicture}
		...
		\PARPROCESSNODE{C}{\PAREXCHANGE}{(Thursday Discussion)}{Exchange Feedback}{(2*\spacing,0)}
		\PARPROCESSNODE{D}{\PARREVISE}{(At Home)}{Revise}{(3*\spacing,0)}
		\PARPROCESSNODE{E}{\PARSUBMIT}{(Friday Class)}{Submit}{(4*\spacing,0)}
	...
	The alien world of Robotron is inhabited by billions of tiny nanobots.  These nanobots
